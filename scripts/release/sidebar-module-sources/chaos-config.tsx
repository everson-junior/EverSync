...
export default function ChaosConfigModule() {
  ...
  useEffect(() => {
    getHost()
      ...
      .catch((e: unknown) =>
        setError(e instanceof Error ? e.message : "Unable to load chaos configuration.")
      );
  }, []);
  return (
    <main className="mx-auto max-w-5xl space-y-4 p-4">
      <h1 className="text-2xl font-bold text-text-main">Chaos mode</h1>
      {data ? (
