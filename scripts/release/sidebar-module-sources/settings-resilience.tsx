...
export default function SettingsResilienceModule() {
  ...
  useEffect(() => {
    getHost()
      ...
      .catch((x: unknown) =>
        se(x instanceof Error ? x.message : "Unable to load resilience settings.")
      );
  }, []);
  return (
    <main className="mx-auto max-w-5xl space-y-4 p-4">
      <h1 className="text-2xl font-bold text-text-main">Resilience settings</h1>
      {d ? (
