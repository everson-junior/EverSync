...
export default function SettingsAiModule() {
  ...
  useEffect(() => {
    getHost()
      ...
      .catch((x: unknown) => se(x instanceof Error ? x.message : "Unable to load AI settings."));
  }, []);
  return (
    <main className="mx-auto max-w-5xl space-y-4 p-4">
      <h1 className="text-2xl font-bold text-text-main">AI settings</h1>
      {d ? (
