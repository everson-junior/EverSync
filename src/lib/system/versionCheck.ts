...
const NPM_REGISTRY_LATEST_URL = "https://registry.npmjs.org/eversync/latest";
...
const GITHUB_RELEASES_LATEST_URL =
  "https://api.github.com/repos/everson-junior/EverSync/releases/latest";
  ...
  try {
    const res = await fetchImpl(GITHUB_RELEASES_LATEST_URL, {
      ...
      headers: {
        ...
        "User-Agent": "eversync-version-check",
