...
const variants = {
  ...
  secondary:
    "bg-white dark:bg-white/10 cloud:bg-white/10 border border-black/10 dark:border-white/10 cloud:border-white/10 text-text-main hover:bg-black/5 dark:hover:bg-white/5",
  outline:
    "border border-black/15 dark:border-white/15 cloud:border-white/15 text-text-main hover:bg-black/5 dark:hover:bg-white/5",
