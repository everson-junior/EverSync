...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/everson-junior/EverSync/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/everson-junior/EverSync/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/everson-junior/EverSync/blob/main/CHANGELOG.md";
